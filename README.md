...
| Параметр | Описание |
| ------ | ------ |
| ogrn | ОГРН организации, к которой относится риск |
| name | Наименование организации, к которой относится риск  |
| relation | Положение организации в цепочке владения проверяемой компании, может принимать следующие значения: <ul><li>self – проверяемая организация</li><li>founder – является прямым или косвенным учредителем проверяемой организации</li><li>subsidiary – является дочерней организацией по отношению к проверяемой</li></ul> |
| person | Необязательное поле. Описание объекта риска в случае, если им является физическое лицо. Содержит следующие поля: <ul><li>name – фамилия, имя и отчество</li><li>inn – ИНН, если имеется</li><li>position – занимаемая в организации должность</li></ul>  |
| entry | Необязательное поле. Оригинальная строка из соответствующего реестра для возможности ручной проверки |
