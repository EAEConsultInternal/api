...
| Параметр | Описание |
| ------ | ------ |
| type | Описывает положение субъекта риска в цепочке владения проверяемой компании, может принимать следующие значения <ul><li>self</li><li>founders</li><li>established</li></ul> |
