...
| Параметр | Описание |
| ------ | ------ |
| type | Тип объекта – юридическое лицо |
...
| type | Тип объекта <ul><li>legal – юридическое лицо</li><li>person – физическое лицо</li></ul> |
| inn | ИНН субъекта. Проставляется физическим и юридическим лицам |
| ogrn | ОГРН юридического лица. Проставляется только юридическим лицам. Если субъектом является физическое лицо, в поле `ogrn` приходит `null` |
| name | Наименование организации или имя физического лица |
| text | Строка из реестра |
